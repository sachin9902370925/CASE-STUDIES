...
/* QUESTION: Create a reference type called Person. Populate the Personclass with the following properties to store the
 * following information:First name Last name Email address Date of birth Add constructors that accept the following parameter lists:All four parameters First, Last, Email First, Last, Date of birthAdd read-only properties that return the following computed information:Adult -whether or not the person is over 18 Sun sign -the traditional western sun sign of this person Chinese sign -the chinese astrological sign (animal) of this person Birthday -whether or not today is the person's birthday Screen name -a default screen name that you might see 
...
private String FirstName;
        ...
        /*setting email  (have a bit of doubt in this part so didnt display )*/
        public string email
        {
        ...
        /*to check if person is adult or no*/
        public bool IsAdult
        {
            get
            {
        ...
        /*to check birthday is today or no */
    ...
    /*to diplay if person is adult ot no*/
    class Program
    {
        ...
        /* to display if person birthday is today or no*/
        ...
        class Test
        {
            static void Main()
            {
               ...
               Program objProgram = new Program(); 
                ...
                Person m = new Person("Sachin", "Bambhore", new DateTime(1999, 09, 08));
